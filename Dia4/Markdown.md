# 🌿Tarea 3 Mongo DB 2 - Tienda Dia 4
## :electric_plug: Creamos la base de datos 
Creamos una base de datos llamada "tienda"
 ```
use tienda;
 ```
## :inbox_tray: Creacion e insercion de la data a una coleccion
Creación e insertamos la data json copiando el archivo json y insertándola con un insertMany en la colección "productos".
 ```
